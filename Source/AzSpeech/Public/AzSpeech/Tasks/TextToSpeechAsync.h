...
public:
	...
	static UTextToSpeechAsync* TextToSpeech(const UObject* WorldContextObject, const FString& SynthesisText, const FString& VoiceName = "Default", const FString& LanguageID = "Default");
};
