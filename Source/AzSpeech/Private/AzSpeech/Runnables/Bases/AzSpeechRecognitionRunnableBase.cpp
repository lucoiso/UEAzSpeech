...
FAzSpeechRecognitionRunnableBase::FAzSpeechRecognitionRunnableBase(UAzSpeechTaskBase* const InOwningTask, const std::shared_ptr<Microsoft::CognitiveServices::Speech::Audio::AudioConfig>& InAudioConfig) : FAzSpeechRunnableBase(InOwningTask, InAudioConfig)
{
}
...
const Microsoft::CognitiveServices::Speech::OutputFormat FAzSpeechRecognitionRunnableBase::GetOutputFormat() const
{
...
const bool FAzSpeechRecognitionRunnableBase::ApplySDKSettings(const std::shared_ptr<Microsoft::CognitiveServices::Speech::SpeechConfig>& InConfig) const
{
...
bool FAzSpeechRecognitionRunnableBase::ProcessRecognitionResult(const std::shared_ptr<Microsoft::CognitiveServices::Speech::SpeechRecognitionResult>& LastResult)
{
    bool bOutput = true;
