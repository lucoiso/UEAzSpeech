...
FAzSpeechRecognitionRunnable::FAzSpeechRecognitionRunnable(UAzSpeechTaskBase* const InOwningTask,
                                                           std::shared_ptr<MicrosoftSpeech::Audio::AudioConfig>&& InAudioConfig)
	: FAzSpeechRecognitionRunnableBase(InOwningTask, std::move(InAudioConfig))
{
}
