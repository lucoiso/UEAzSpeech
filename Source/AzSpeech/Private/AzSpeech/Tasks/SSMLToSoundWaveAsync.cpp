...
USSMLToSoundWaveAsync* USSMLToSoundWaveAsync::SSMLToSoundWaveAsync(UObject* WorldContextObject, const FString& SynthesisSSML, const FAzSpeechSettingsOptions& Options)
{
