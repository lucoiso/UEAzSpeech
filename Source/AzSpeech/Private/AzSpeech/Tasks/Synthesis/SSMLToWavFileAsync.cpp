...
USSMLToWavFileAsync* USSMLToWavFileAsync::SSMLToWavFile_DefaultOptions(UObject* const WorldContextObject, const FString& SynthesisSSML,
                                                                       const FString& FilePath, const FString& FileName)
{
	return SSMLToWavFile_CustomOptions(WorldContextObject, FAzSpeechSubscriptionOptions(), FAzSpeechSynthesisOptions(), SynthesisSSML, FilePath,
	                                   FileName);
}

USSMLToWavFileAsync* USSMLToWavFileAsync::SSMLToWavFile_CustomOptions(UObject* const WorldContextObject,
